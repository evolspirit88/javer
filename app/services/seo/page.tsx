...
export const metadata: Metadata = { title: 'SEO Edmonton & Calgary' }

const CAPS = [
  { t:"Technical Audit", d:"Deep dive into your website infrastructure and technical performance." },
  { t:"Keyword Research", d:"Identify high-value terms and map them to pages and user intent." },
  { t:"Content Strategy", d:"Optimize existing content or create new content for lead gen or e-commerce." },
  { t:"Local SEO", d:"Enhance visibility in local search results — critical for Edmonton & Calgary businesses." },
  { t:"Link Acquisition", d:"Build authority through strategic backlink acquisition and PR outreach." },
  { t:"Ongoing Optimization", d:"SEO is a long-term investment. We monitor, report, and continuously improve." }
]
const WHY  = [
  { t:"Technical + Content", d:"We combine technical expertise with precise, scalable content optimization." },
  { t:"Long-Term ROI", d:"SEO compounds over time. The work we do today drives organic traffic for years." },
  { t:"Local Expertise", d:"We specialize in local SEO for Edmonton and Calgary businesses." },
  { t:"Transparent", d:"Monthly reports showing rankings, traffic, and the direct impact of every action." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — SEO" title="SEO" subtitle="Sustainable organic growth through technical excellence, keyword strategy, and local SEO." photo="https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=1600&q=85&auto=format&fit=crop" ctaLabel="Get a Free SEO Audit" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                Sustainable organic growth through technical excellence, keyword strategy, and local SEO.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">Get a Free SEO Audit</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
