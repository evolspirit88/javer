...
const CAPS = [
  { t:"Data Collection", d:"Gather accurate data about customers and competition before a pixel is designed." },
  { t:"Branding Research", d:"Research your logos, posts, and ads to determine ideal market positioning." },
  { t:"Sales Funnel Design", d:"Every design decision blends the sales funnel — from hero section to CTA." },
  { t:"Launch & Monitor", d:"CRO monitoring for 3 months after launch with iterative improvements." }
]
const WHY  = [
  { t:"Personalized", d:"Solutions tailored to your unique goals — no cookie-cutter templates." },
  { t:"Data-Driven", d:"Every design decision backed by real analytics and user behaviour research." },
  { t:"CRO-Focused", d:"We do not just build beautiful sites. We build sites that convert visitors into customers." },
  { t:"Transparent", d:"Clear pricing, honest timelines, and no hidden fees." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — Web Design" title="Website Design" subtitle="Conversion-first design that turns visitors into revenue — built to perform around the clock." photo="https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=1600&q=85&auto=format&fit=crop" ctaLabel="See Our Work & Get a Quote" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                Conversion-first design that turns visitors into revenue — built to perform around the clock.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">See Our Work & Get a Quote</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
