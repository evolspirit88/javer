...
export const metadata: Metadata = { title: 'Advanced Marketing Analytics' }

const CAPS = [
  { t:"Data Warehouse", d:"Design and implementation of scalable data warehouses — BigQuery, Snowflake, and more." },
  { t:"Attribution Modelling", d:"Identify the factors contributing to outcomes and allocate credit accurately across channels." },
  { t:"Dashboard Creation", d:"Dynamic live dashboards in Looker Studio accessible to every stakeholder." },
  { t:"Consent Management", d:"Compliant CMP platforms that balance data collection with user privacy rights." },
  { t:"GA4 Advanced", d:"Custom dimensions, BigQuery export, and advanced reporting configurations." },
  { t:"MARTECH Consulting", d:"Help selecting, implementing, and effectively using the right marketing technologies." }
]
const WHY  = [
  { t:"Technical + Marketing", d:"We understand both the technical data layer and the marketing strategy on top of it." },
  { t:"Privacy & Compliance", d:"GDPR, CCPA, and Canadian privacy regulations built into every engagement." },
  { t:"Actionable", d:"We do not just collect data. We help you act on it to drive real business outcomes." },
  { t:"Custom", d:"Every business has unique data needs. We build for your specific context." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — Advanced Analytics" title="Advanced Analytics" subtitle="Collect, Unify, Activate — a full-stack data strategy that powers smarter marketing decisions." photo="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1600&q=85&auto=format&fit=crop" ctaLabel="Book a Free Data Strategy Call" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                Collect, Unify, Activate — a full-stack data strategy that powers smarter marketing decisions.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">Book a Free Data Strategy Call</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
