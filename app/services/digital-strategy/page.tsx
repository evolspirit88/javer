...
export const metadata: Metadata = { title: 'Digital Strategy' }

const CAPS = [
  { t:"Brand Positioning", d:"A distinctive positioning statement that captures your brand essence." },
  { t:"Audience Insights", d:"Comprehensive research covering demographics, psychographics, and behaviour." },
  { t:"Competitive Analysis", d:"Deep-dive competitor review to identify gaps and whitespace you can own." },
  { t:"Media Planning", d:"Platform-agnostic approach to maximize reach across owned, earned, and paid channels." }
]
const WHY  = [
  { t:"Foundation First", d:"Strategy is the foundation every tactic is built on. Without it, you are guessing." },
  { t:"Data-Driven", d:"Every recommendation grounded in real data — not opinions or assumptions." },
  { t:"Iterative", d:"Once launched, our strategists are involved every step to refine and optimize." },
  { t:"Business-Aligned", d:"Goals tied directly to revenue outcomes, not vanity metrics." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — Digital Strategy" title="Digital Strategy" subtitle="The era of marketing campaigns that lack purpose is over." photo="https://images.unsplash.com/photo-1553877522-43269d4ea984?w=1600&q=85&auto=format&fit=crop" ctaLabel="Book a Free Strategy Session" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                The era of marketing campaigns that lack purpose is over.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">Book a Free Strategy Session</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
