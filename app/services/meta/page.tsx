...
const CAPS = [
  { t:"Account Setup", d:"Full pixel implementation and Conversion API setup for reliable data collection." },
  { t:"Audience Targeting", d:"Precise audience identification using first-party data, lookalikes, and behavioural targeting." },
  { t:"Creative Strategy", d:"Performance-driven creatives and ad copy tested and optimized continuously." },
  { t:"Retargeting", d:"Strategic retargeting campaigns to re-engage high-intent visitors across the Meta ecosystem." },
  { t:"Conversion API", d:"Server-side tracking to maintain data accuracy post-iOS 14." },
  { t:"Reporting", d:"Clear monthly reports with analysis, insights, and actionable recommendations." }
]
const WHY  = [
  { t:"Meta Business Partner", d:"Our Meta partnership gives us access to priority support, training, and exclusive betas." },
  { t:"Creative Expertise", d:"Performance creative is the single biggest lever on paid social — we invest in it." },
  { t:"Privacy-Compliant", d:"Conversion API implementation ensures your data stays accurate." },
  { t:"Full-Funnel", d:"We plan campaigns across awareness, consideration, and conversion." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — Paid Social" title="Facebook & Instagram Ads" subtitle="Cutting-edge social advertising built for the cookieless era." photo="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=1600&q=85&auto=format&fit=crop" ctaLabel="Get a Free Meta Ads Audit" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                Cutting-edge social advertising built for the cookieless era.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">Get a Free Meta Ads Audit</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
