...
const CAPS = [
  { t:"Analytics Audit", d:"Full review of your current tracking to identify gaps, errors, and data quality issues." },
  { t:"GA4 Implementation", d:"Complete GA4 property setup with advanced event tracking and custom dimensions." },
  { t:"Google Tag Manager", d:"Clean, scalable tag management architecture for all your tracking needs." },
  { t:"Conversion API", d:"Server-side tracking for Meta and other platforms — privacy-first accuracy." },
  { t:"Call Tracking", d:"Attribute every phone call back to the correct marketing channel." },
  { t:"QA & Launch", d:"Rigorous quality assurance before every launch to ensure reliability from day one." }
]
const WHY  = [
  { t:"Accuracy First", d:"Reliable data is the foundation of every decision we make. We get tracking right first." },
  { t:"Privacy-Compliant", d:"All implementations aligned with GDPR, CCPA, and Canadian privacy regulations." },
  { t:"Platform Agnostic", d:"We work across Google, Meta, Microsoft, and custom platforms to unify your data." },
  { t:"Training", d:"We train your team to read and act on the data — not just collect it." }
]
...
export default function ServicePage() {
  return (
    <>
      <style>{GRID_S}</style>
      <ServiceHero eyebrow="Service — Analytics & Tracking" title="Campaign Tracking" subtitle="Without accurate tracking, it is impossible to tell if your marketing is working." photo="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=85&auto=format&fit=crop" ctaLabel="Get a Free Analytics Health Check" />
          ...
          <div>
            ...
            <Reveal delay={100}>
              <p style={{fontFamily:'var(--serif)',fontSize:17,fontStyle:'italic',color:'rgba(240,235,225,.4)',lineHeight:1.8,marginBottom:36}}>
                Without accurate tracking, it is impossible to tell if your marketing is working.
              </p>
            </Reveal>
            <Reveal delay={140}>
              <Link href="/get-a-proposal" className="btn btn-g">Get a Free Analytics Health Check</Link>
            </Reveal>
          </div>
          <Reveal dir="right">
        ...
        <div style={{position:'relative',zIndex:2,textAlign:'center',maxWidth:640}}>
          ...
          <Reveal dir="up" delay={80}>
            <Link href="/get-a-proposal" className="btn btn-g" style={{fontSize:12,padding:'17px 48px'}}>
              Get a Free Analytics Health Check
            </Link>
          </Reveal>
        </div>
      </section>
